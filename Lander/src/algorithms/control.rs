    ...
    fn set_flight_phase(&mut self, phase: FlightPhase) {
        ...
        if !self.manual_weights {
            match phase {
                ...
                FlightPhase::Descent => {
                    self.q = Array2::<f64>::from_diag(&Array1::from(vec![
                        2581.2760152465316, 2581.2760152465316, 2850.2894287298072,
                        153952.51432655362, 153952.51432655362, 0.0, 0.0,
                        4925.817442923313, 4925.817442923313, 43149.09763456765,
                        1272.2083794015007, 1272.2083794015007, 341.8801807355727
                    ]));
                    self.r = Array2::<f64>::from_diag(&Array1::from(vec![50.0, 50.0, 0.005]));
                    self.qn = Array2::<f64>::from_diag(&Array1::from(vec![
                        3751.4154546696036, 3751.4154546696036, 232883.3717062377,
                        850424.1773416643, 850424.1773416643, 0.0, 0.0,
                        8880.761118752294, 8880.761118752294, 174174.75839327063,
                        7560.800564678034, 7560.800564678034, 4080.2896730933758
                    ]));
                }
                _ => {}
            }
