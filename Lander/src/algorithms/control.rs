    ...
    fn set_flight_phase(&mut self, phase: FlightPhase) {
        ...
        if !self.manual_weights {
            match phase {
                ...
                FlightPhase::Descent => {
                    self.q = Array2::<f64>::from_diag(&Array1::from(vec![
                        6508.323292537923, 6508.323292537923, 9115.48010828047,
                        467087.2077862642, 467087.2077862642, 0.0, 0.0,
                        9083.715239864196, 9083.715239864196, 78395.07161057014,
                        1785.9050852957046, 1785.9050852957046, 3683.2395031767137
                    ]));
                    self.r = Array2::<f64>::from_diag(&Array1::from(vec![50.0, 50.0, 0.005]));
                    self.qn = Array2::<f64>::from_diag(&Array1::from(vec![
                        37659.8799242139, 37659.8799242139, 169674.0667006764,
                        469799.66033826885, 469799.66033826885, 0.0, 0.0,
                        30167.533428482493, 30167.533428482493, 3838253.9779663184,
                        1042.5205130922227, 1042.5205130922227, 8913.511055776733
                    ]));
                }
                _ => {}
            }
