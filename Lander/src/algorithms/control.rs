    ...
    fn set_flight_phase(&mut self, phase: FlightPhase) {
        ...
        if !self.manual_weights {
            match phase {
                ...
                FlightPhase::Descent => {
                    self.q = Array2::<f64>::from_diag(&Array1::from(vec![
                        3226.4528374354763, 3226.4528374354763, 4949.295587622378,
                        151296.8055060992, 151296.8055060992, 0.0, 0.0,
                        2085.6594665731814, 2085.6594665731814, 27624.301096534473,
                        708.7654917149806, 708.7654917149806, 452.5764672153003
                    ]));
                    self.r = Array2::<f64>::from_diag(&Array1::from(vec![50.0, 50.0, 0.005]));
                    self.qn = Array2::<f64>::from_diag(&Array1::from(vec![
                        8774.334425140658, 8774.334425140658, 76188.62616243494,
                        92787.844412346, 92787.844412346, 0.0, 0.0,
                        5864.434160823332, 5864.434160823332, 226288.8229183432,
                        1792.2935799016268, 1792.2935799016268, 4615.218812465666
                    ]));
                }
                _ => {}
            }
