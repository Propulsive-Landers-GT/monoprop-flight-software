    ...
    fn set_flight_phase(&mut self, phase: FlightPhase) {
        ...
        if !self.manual_weights {
            match phase {
                ...
                FlightPhase::Descent => {
                    self.q = Array2::<f64>::from_diag(&Array1::from(vec![
                        1787.8847784579712, 1787.8847784579712, 3303.815880325937,
                        157797.00032851895, 157797.00032851895, 0.0, 0.0,
                        9056.553403100868, 9056.553403100868, 6887.10424699583,
                        462.37829268914885, 462.37829268914885, 680.6061215390149
                    ]));
                    self.r = Array2::<f64>::from_diag(&Array1::from(vec![50.0, 50.0, 0.005]));
                    self.qn = Array2::<f64>::from_diag(&Array1::from(vec![
                        2246.0935069884395, 2246.0935069884395, 78742.44841129082,
                        194412.36871470307, 194412.36871470307, 0.0, 0.0,
                        9831.100189265464, 9831.100189265464, 158355.99118582194,
                        4833.079506376506, 4833.079506376506, 344.10166581461505
                    ]));
                }
                _ => {}
            }
