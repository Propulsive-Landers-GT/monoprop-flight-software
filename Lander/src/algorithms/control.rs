    ...
    fn set_flight_phase(&mut self, phase: FlightPhase) {
        ...
        if !self.manual_weights {
            match phase {
                ...
                FlightPhase::Descent => {
                    self.q = Array2::<f64>::from_diag(&Array1::from(vec![
                        3953.546107705742, 3953.546107705742, 1782.1445133917186,
                        139982.53982472257, 139982.53982472257, 0.0, 0.0,
                        4487.585669548984, 4487.585669548984, 38997.15202929076,
                        345.21674345598456, 345.21674345598456, 1167.7296473221277
                    ]));
                    self.r = Array2::<f64>::from_diag(&Array1::from(vec![50.0, 50.0, 0.005]));
                    self.qn = Array2::<f64>::from_diag(&Array1::from(vec![
                        5256.618511945485, 5256.618511945485, 154266.09494661423,
                        685089.3009249978, 685089.3009249978, 0.0, 0.0,
                        4179.252461881753, 4179.252461881753, 220899.37150167822,
                        9188.161276395462, 9188.161276395462, 9998.290894426
                    ]));
                }
                _ => {}
            }
