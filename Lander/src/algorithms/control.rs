    ...
    fn set_flight_phase(&mut self, phase: FlightPhase) {
        ...
        if !self.manual_weights {
            match phase {
                ...
                FlightPhase::Descent => {
                    self.q = Array2::<f64>::from_diag(&Array1::from(vec![
                        303.6281353565555, 303.6281353565555, 948.5392215326402,
                        51009.488606315485, 51009.488606315485, 0.0, 0.0,
                        433.37881247381057, 433.37881247381057, 25000.502551171383,
                        1258.519157567494, 1258.519157567494, 1925.0226617422484
                    ]));
                    self.r = Array2::<f64>::from_diag(&Array1::from(vec![50.0, 50.0, 0.005]));
                    self.qn = Array2::<f64>::from_diag(&Array1::from(vec![
                        8911.347635031258, 8911.347635031258, 61356.67841083754,
                        191655.8733928851, 191655.8733928851, 0.0, 0.0,
                        6540.091521540343, 6540.091521540343, 59708.1838044248,
                        4713.715291714453, 4713.715291714453, 495.2838670773943
                    ]));
                }
                _ => {}
            }
