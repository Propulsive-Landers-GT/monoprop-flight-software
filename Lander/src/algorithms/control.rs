    ...
    fn set_flight_phase(&mut self, phase: FlightPhase) {
        ...
        if !self.manual_weights {
            match phase {
                ...
                FlightPhase::Descent => {
                    self.q = Array2::<f64>::from_diag(&Array1::from(vec![
                        1210.5678989449118, 1210.5678989449118, 1001.6387936373483,
                        194508.35545624033, 194508.35545624033, 0.0, 0.0,
                        677.1885271046763, 677.1885271046763, 28079.395705259296,
                        1672.0962630929455, 1672.0962630929455, 1636.9821555417002
                    ]));
                    self.r = Array2::<f64>::from_diag(&Array1::from(vec![50.0, 50.0, 0.005]));
                    self.qn = Array2::<f64>::from_diag(&Array1::from(vec![
                        9646.523517643993, 9646.523517643993, 101051.39139425485,
                        173841.88378111066, 173841.88378111066, 0.0, 0.0,
                        5996.162064548803, 5996.162064548803, 176322.1093135902,
                        4257.89214027924, 4257.89214027924, 3838.7731430222816
                    ]));
                }
                _ => {}
            }
